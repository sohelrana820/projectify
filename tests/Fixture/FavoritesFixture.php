...
class FavoritesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'favorites_ibfk_2' => ['type' => 'foreign', 'columns' => ['property_id'], 'references' => ['properties', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'property_id' => 1,
            'created' => '2016-03-06 07:38:17',
            'modified' => '2016-03-06 07:38:17'
        ],
    ];
}
