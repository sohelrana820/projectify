...
class MessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'uuid' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'attachments' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        'type' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => 'type: 1 = sent, 2 = reply', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'messages_ibfk_2' => ['type' => 'foreign', 'columns' => ['sender_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'messages_ibfk_1' => ['type' => 'foreign', 'columns' => ['message_id'], 'references' => ['messages', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'type' => 1,
            'created' => '2016-03-16 13:31:52',
            'modified' => '2016-03-16 13:31:52'
        ],
    ];
}
