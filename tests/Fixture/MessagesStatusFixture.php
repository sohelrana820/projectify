...
/**
 * MessagesStatusFixture
 *
 */
class MessagesStatusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'messages_status_ibfk_2' => ['type' => 'foreign', 'columns' => ['message_id'], 'references' => ['messages', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'messages_status_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'marked_as' => 1,
            'status' => 1,
            'created' => '2016-03-15 09:06:04',
            'modified' => '2016-03-15 09:06:04'
        ],
    ];
}
